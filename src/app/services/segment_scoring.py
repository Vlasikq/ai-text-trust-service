"""Per-sentence scoring сервис: разбиение текста на окна предложений и
оценка каждого окна детектором.

Reusable-модуль для (a) endpoint'а `/api/v1/analyze/segments` и (b) ноутбуков.
